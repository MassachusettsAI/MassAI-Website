...
<div class="flex justify-center">
  <Card.Root class="bg-sky-200 mb-14 max-w-3xl w-full dark:bg-sky-950">
    <Card.Header>
      <Card.Title class="font-fraunces flex items-center justify-center text-blue-600 dark:text-blue-400 text-4xl">Upcoming Events</Card.Title>
    </Card.Header>
    ...
    <div class="flex justify-center mb-6">
      <button
          ...
          on:click={() => window.open(calendarUrl, '_blank')}
      >
