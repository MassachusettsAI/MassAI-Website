<div class="text-lg text-center">
  ...
  Self-led projects are chosen by groups of students, we'll help match you to students with similar interests during the first meeting. Teams will be finalized during the second meeting. You'll receive mentorship from MassAI, but you have full freedom to lead the project.
  Club-led projects are chosen by groups of students and the club. They are led by a project lead on the E-Board. We'll match you to club-led projects in the first meeting and finalize teams in the second meeting.
</div>
<ol class="ml-5 relative m-4 border-s border-gray-400 dark:border-gray-700">
  <li class="mb-4 ms-6">
    <span class="absolute flex items-center justify-center w-6 h-6 bg-green-100 rounded-full -start-3 ring-8 ring-white dark:ring-slate-800 dark:bg-green-200">
      <svg class="w-6 h-6 text-green-400 dark:text-green-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  <li class="mb-4 ms-6">
    <span class="absolute flex items-center justify-center w-6 h-6 bg-lime-100 rounded-full -start-3 ring-8 ring-white dark:ring-slate-800 dark:bg-lime-200">
      <svg class="w-6 h-6 text-lime-400 dark:text-lime-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  ...
  <li class="mb-4 ms-6">
    <span class="absolute flex items-center justify-center w-6 h-6 bg-yellow-100 rounded-full -start-3 ring-8 ring-white dark:ring-slate-800 dark:bg-yellow-100">
      <svg class="w-6 h-6 text-amber-400 dark:text-amber-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
