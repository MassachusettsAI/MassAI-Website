...
<ol class="ml-5 relative m-4 border-s border-gray-400 dark:border-gray-700">
  <li class="mb-4 ms-6">
    <span class="absolute flex items-center justify-center w-6 h-6 bg-emerald-100 rounded-full -start-3 ring-8 ring-white dark:ring-slate-800 dark:bg-emerald-200">
      <svg class="w-6 h-6 text-emerald-400 dark:text-emerald-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  <li class="mb-4 ms-6">
    <span class="absolute flex items-center justify-center w-6 h-6 bg-green-100 rounded-full -start-3 ring-8 ring-white dark:ring-slate-800 dark:bg-green-200">
      <svg class="w-6 h-6 text-green-400 dark:text-green-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
