<script lang="ts">
    const eBoardMembers = [
        ...
        },
        {
            ...
            title: "Workshop Lead",
            picture: "/images/ml-logo-border.jpeg",
            bio: "Howdy, I'm Eric! Originally from Austin, TX, I'm a first-year grad student in the MSCS program after having graduated from Texas A&M with my Bachelor's in Spring 2024, and I'm excited to serve as a workshop lead this semester! Outside of computer science, my other interests are in hiking and music (you can also find me active on WMUA-FM). Looking forward to an amazing semester with y'all!"
        },
        {
            name: "Ashna Guha",
            title: "Webmaster",
...
<div class="text-center mb-10">
    <h1 class="font-fraunces font-extrabold text-5xl">Leadership</h1>
</div>
